...
function Exercise(props) {
  ...
  const length = props.lesson.questions.length;
    ...
    <div className="exercise">
      ...
      <div className="main-content">
        {questionNumber < length ? (
          <React.Fragment>
            <ProgressBar progress={(questionNumber / length) * 100} />
            <p className="white-text question-count">
              Question {questionNumber + 1} of {length}
            </p>
            {props.lesson.questions[questionNumber].type ===
              "multiple_choice" && (
              <MultipleChoice
                nextQuestion={nextQuestion}
                question={props.lesson.questions[questionNumber].question}
                answers={shuffle(
                  props.lesson.questions[questionNumber].answers
                )}
              />
            )}
            {props.lesson.questions[questionNumber].type === "fill_in" && (
              <FillQuestion
                nextQuestion={nextQuestion}
                question={props.lesson.questions[questionNumber].question}
                text={props.lesson.questions[questionNumber].text}
              />
            )}
          </React.Fragment>
        ) : (
          <div className="results">
            <div className="">
              ...
              <ProgressBar progress={(correctCount / length) * 100} />
            ...
            <Button
              ...
              type="transparent"
              onClick={() => {
                props.handleEnd((correctCount / length) * 100);
              }}
              styles={{
