...
function SideBar(props) {
  ...
  const title =
    props.authType.charAt(0).toUpperCase() + props.authType.slice(1);
  ...
  return (
    <div className="side-bar">
      ...
      <form
        onSubmit={props.authType === "login" ? login : signUp}
        className="info-form"
      >
        <TextInput
          type="email"
      ...
      <p className="body-text switch-account-text">
        ...
        <button
          ...
          onClick={props.switchAuth}
        >
          {props.authType === "sign up" ? "Login" : "Sign up"}
        </button>
      </p>
    </div>
  );
